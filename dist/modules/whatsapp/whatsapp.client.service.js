...
let WhatsAppClientService = WhatsAppClientService_1 = class WhatsAppClientService {
    constructor(whatsappService, outboundRouter, sessionService) {
        this.whatsappService = whatsappService;
        this.outboundRouter = outboundRouter;
        this.sessionService = sessionService;
        this.logger = new common_1.Logger(WhatsAppClientService_1.name);
        this.enabled = String(process.env.WHATSAPP_EMBEDDED_CLIENT_ENABLED || 'true').toLowerCase() !== 'false';
        this.client = null;
